/*!
 * Trello JSON parsing library, designed for Gulp.
 *
 * Produces a simplified JSON output ideal for gulp-file-include's
 * FOR looping over JSON.
 *
 * @author   Chris Gurney <https://chrisgurney.ca/>
 */
